#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/bootdevice/by-name/recovery:12742928:774c088ca8298b69aadf672b8318ea066387f6e1; then
  applypatch EMMC:/dev/block/bootdevice/by-name/boot:11362576:ca1298b7bea1566bc60efcbfb86a1685f0940cae EMMC:/dev/block/bootdevice/by-name/recovery 774c088ca8298b69aadf672b8318ea066387f6e1 12742928 ca1298b7bea1566bc60efcbfb86a1685f0940cae:/system/recovery-from-boot.p || echo 454 > /cache/fota/fota.status
else
